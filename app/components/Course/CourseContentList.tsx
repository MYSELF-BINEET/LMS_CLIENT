...
const CourseContentList: FC<Props> = (props) => {
  ...
  ? Array.from(new Set(props.data.map((item: { videoSection: string }) => item.videoSection))) 
  : [];
          ...
          <div className={`${!props.isDemo && 'border-b border-[#0000001c] dark:border-[#ffffff8e] pb-2'}`} key={section}>
            <div className="flex w-full">
              ...
              >
                ...
                <button
                  className="mr-4 text-black cursor-pointer dark:text-white"
              ...
              <div className="w-full">
                {sectionVideos.map((item: any, index: number) => {
                  ...
                  return (
                    <div
                      className={`w-full ${
                        videoIndex === props.activeVideo ? "bg-slate-400 " : ""
